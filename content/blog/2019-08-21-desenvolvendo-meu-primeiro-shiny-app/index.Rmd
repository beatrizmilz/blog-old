...
excerpt: "O objetivo deste post é compartilhar um pouco sobre a minha experiência no desenvolvimento do meu primeiro Shiny App."
author: "Beatriz Milz"
date: 2019-08-21
categories:
  - Shiny
...
O objetivo deste post é compartilhar um pouco sobre a **minha** experiência no desenvolvimento do meu primeiro [Shiny App](https://shiny.rstudio.com/). O Shiny é um pacote do `R` utilizado para desenvolver web apps interativos. Exemplos de Shiny Apps estão disponíveis [nessa página](https://shiny.rstudio.com/gallery/). 
...
Os dados foram obtidos no website da [CAPES](https://sucupira.capes.gov.br/sucupira/public/consultas/coleta/veiculoPublicacaoQualis/listaConsultaGeralPeriodicos.jsf). A página permite o download de uma tabela contendo o ISSN, título do periódico, área de avaliação e a nota na respectiva área. Utilizei os dados da avaliação mais recente disponível em junho/2019: 2013-2016.
...
Sobre o aprendizado de Shiny, eu gostaria de praticar mais. Já tenho uma ideia para um próximo Shiny App, agora o que falta é ter tempo para isso. Além disso, gostaria de aprender a utilizar o pacote [`golem`](https://github.com/ThinkR-open/golem), e a deixar meus Apps disponíveis em outras plataformas, como por exemplo na [AWS](https://aws.amazon.com/pt/) ou [Digital Ocean](https://www.digitalocean.com).  
